{{-- LOKASI & KONDISI KAMAR INDEKOS USER 1 (C3-C5-U1) --}}
    ...
    <label>Lokasi Indekos</label>
        <div class="slider-container1">
            ...
            <input 
                ...
                step="1" 
                value="9" 
                oninput="updateValue9u1(this.value)">
            <span class="value-label" id="sliderValue9u1">1</span>
            <div class="slider-tooltip-1" id="sliderTooltip9u1">1</div>
...
<script>
const slider9u1 = document.getElementById('slider9u1');
const sliderValue9u1 = document.getElementById('sliderValue9u1');
const sliderTooltip9u1 = document.getElementById('sliderTooltip9u1');

function updateValue9u1(value) {
    const snappedValue = values[value - 1];
    sliderValue9u1.innerText = snappedValue;
    slider9u1.setAttribute('data-snapped-value', snappedValue);
    sliderTooltip9u1.innerText = snappedValue;
}

slider9u1.addEventListener('input', (event) => {
    const value = parseInt(event.target.value);
    updateValue9u1(value);
});

updateValue9u1(slider9u1.value);
</script>
