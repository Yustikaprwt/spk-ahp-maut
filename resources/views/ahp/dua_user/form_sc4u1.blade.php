...
<div class="input-group">
    <label for="C4A-C4B-U1">Kondisi Lingkungan & Bangunan Indekos</label>
        <select name="C4A-C4B-U1" id="C4A-C4B-U1">
    ...
    <label for="C4A-C4B-U1">Sistem Keamanan Lingkungan Indekos</label>
    </div>